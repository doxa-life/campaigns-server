        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <UCard>
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="text-sm text-[var(--ui-text-dimmed)]">All Time Subscribers</p>
          ...
          <UCard>
            <div class="flex items-center gap-3">
              <UIcon name="i-lucide-user-x" class="text-[var(--ui-primary)] text-2xl" />
              <div>
                <p class="text-sm text-[var(--ui-text-dimmed)]">Total Inactive</p>
                <p class="text-2xl font-bold">{{ subscribersData.totalInactive }}</p>
              </div>
            </div>
          </UCard>
          <UCard>
...
const allNavLinks = [
  { label: 'Prayer Libraries', to: '/admin/libraries', icon: 'i-lucide-book-open', permission: 'content.view', unscopedOnly: true },
  { label: 'People Group Data', to: '/admin/people-groups', icon: 'i-lucide-globe', permission: 'people_groups.view' },
  { label: 'Contacts', to: '/admin/subscribers', icon: 'i-lucide-user', permission: 'subscribers.view' },
  { label: 'Groups (Adoption)', to: '/admin/groups', icon: 'i-lucide-users', permission: 'groups.view' },
