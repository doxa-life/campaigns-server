 ...
 * Body: { term?, fields?, section_id?, position?, seed? }
 *
 * Changing the headword or its annotations invalidates every review of the
 * term, so confirmed translations of it drop back to draft and are marked
 * stale.
 */
